...
import edu.upenn.cis.cis455.crawler.handlers.ChannelHandler;
import edu.upenn.cis.cis455.crawler.handlers.CrawlerHandler;
...
public class WebInterface {
    public static void main(String args[]) {
        ...
        //Register route to parse channel name and xpath
        get("/create/:name", new ChannelHandler(database));
        get("/show", new CrawlerHandler(database));
        awaitInitialization();
    }
}
