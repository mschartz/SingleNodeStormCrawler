...
public class OccurrenceEvent extends Tuple {
    ...
    public OccurrenceEvent(String docId, EventType type, String value, int depth) {
        super(new Fields("docId","type","value", "depth"), new ArrayList<Object>());
